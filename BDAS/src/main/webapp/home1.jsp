...
<body>
	<div id="menu-bar">
			...
			<ul class="nav" id="nav">
				<li><a href="MakeMDSmile/Articles/articles.jsp">Citește un articol!</a></li>
  ...
  <div class="carousel__cards">
    <div class="carousel__card">
        <a href="MakeMDSmile/Articles/articles.jsp#art1"><h5>Ce este depresia și cum te poate afecta?</h5>	
      	<img class="carousel__img" src="MakeMDSmile/Home/pics/art1.png"></a>
    </div>
    <div class="carousel__card">
    	<a href="MakeMDSmile/Articles/articles.jsp#art2"><h5>Cum se manifestă un atac de panică?</h5>
      	<img class="carousel__img" src="MakeMDSmile/Home/pics/art2.png"></a>
    </div>
    <div class="carousel__card">
    	<a href="MakeMDSmile/Articles/articles.jsp#art3"><h5>Situațiile de stres</h5>
      	<img class="carousel__img" src="MakeMDSmile/Home/pics/art3.png"></a>
    </div>
    <div class="carousel__card">
    	<a href="MakeMDSmile/Articles/articles.jsp#art4"><h5>Totul despre PTSD</h5>
      	<img class="carousel__img" src="MakeMDSmile/Home/pics/art4.png"></a>
    </div>
    <div class="carousel__card">
    	<a href="MakeMDSmile/Articles/articles.jsp#art5"><h5>Află cu ce tulburări se poate confrunta gândirea ta</h5>
      	<img class="carousel__img" src="MakeMDSmile/Home/pics/art5.png"></a>
    </div>
    <div class="carousel__card">
    	<a href="MakeMDSmile/Articles/articles.jsp#art6"><h5>Ce sunt dereglările de voință și care sunt acestea?</h5>
      	<img class="carousel__img" src="MakeMDSmile/Home/pics/art6.png"></a>
    </div>
    <div class="carousel__card">
    	<a href="MakeMDSmile/Articles/articles.jsp#art7"><h5>Prin ce se caracterizează reacția acută de stres?</h5>
      	<img class="carousel__img" src="MakeMDSmile/Home/pics/art7.png"></a>
    </div>
    <div class="carousel__card">
    	<a href="MakeMDSmile/Articles/articles.jsp#art8"><h5>Ideile obsesive, prelevante și delirante</h5>
...
<div class="chat-bar-collapsible">
        <button type="button" class="collapsible">Lasă-ne un feedback!
            <img id="chat-button" src="MakeMDSmile/Home/pics/chat.png">
        </button>
                    ...
                    <div class="chat-container">
                        ...
                        <div class="chat-bar-input-block">
                            ...
                            <div class="chat-bar-icons">
                            	<img id="chat-icon" onclick="heartButton()" src="MakeMDSmile/Home/pics/heart.png">
                                <img id="chat-icon" onclick="sendButton()" src="MakeMDSmile/Home/pics/send.png">
                            </div>
                        </div>
